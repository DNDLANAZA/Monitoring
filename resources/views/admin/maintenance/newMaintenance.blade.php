                ...
                <div class="card-body">
                    <form method="POST" id="datatake" role="form" action="{{ route('maintenance.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control" name="diagnostique" placeholder="Type your diagnostique" required></textarea>
                        </div>

                        <div class="mb-2">
                            <label for="reference" class="form-label"> What are the actions taken? </label>
                            <textarea class="form-control" name="action" placeholder="Type your action" required></textarea>
                        </div>
